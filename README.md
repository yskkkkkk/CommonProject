...
> 학기 팀 프로젝트로 진행했습니다 (4인, 2022년 초 · 약 3.5주 스프린트).
...
- 애플리케이션 설정(`backend/src/main/resources/application.properties`)에는 하드코딩된 자격증명이 남아 있어, 별도의 보안 정리(자격증명 폐기·환경변수 이전)가 필요합니다.
